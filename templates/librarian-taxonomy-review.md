...
5. **Escalate** — If a tag should be **studio-wide**, run **`promote-cpl-to-col.txt`** (or human PR) with sanitized wording. If a tag should be **global for all Calyx users**, open/track a **calyx-core** change — do not silently fork core vocabulary in one project without an ADR.
...
- **`prompts/promote-cpl-to-col.txt`** — cpl → col promotion assistant
