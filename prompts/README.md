...
| `promote-cpl-to-col.txt` | **Org lift** — AI-guided lift from **cpl** to **col**: redact, propose org-repo bodies + PR checklist; human merges | When `.calyx/org/` exists and a human authorizes sharing; see `.calyx/AGENT_ROLES.md` |
| `org-lift-cadence.txt` | **Cadence + nudges** — when to org lift; how assistants should remind at checkpoint without blocking commits | Weekly checkpoint, milestones, monthly hygiene; pair with **`calyx-closeout.md`** |
